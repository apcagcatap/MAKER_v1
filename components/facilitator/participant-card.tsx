...
export function ParticipantCard({ 
  ...
  return (
    <Link
      ...
      className={`block bg-white rounded-xl border-2 p-6 hover:shadow-lg transition-shadow ${
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2 mb-1">
            <h3 className="text-lg font-bold text-gray-900 truncate">{participant.display_name || "Unknown User"}</h3>
            {isAtRisk && (
          ...
          <p className="text-sm text-gray-600 mb-3 truncate">{participant.email}</p>

          <div className="grid grid-cols-2 gap-4 mb-3">
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-1 text-gray-600">
                <TrendingUp className="w-4 h-4 text-purple-500" />
                <span className="text-sm">Level {participant.level}</span>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-1 text-gray-600">
                <Trophy className="w-4 h-4 text-yellow-500" />
                <span className="text-sm">{participant.xp} XP</span>
              </div>
            </div>
          </div>
